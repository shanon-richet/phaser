...
function create() {
        ...
        map = game.add.bitmapData(0, 0)
        map.rect(20, 50, 120, 120, '#fff')
        map_2 = game.add.bitmapData(500, 500)
        map_2.rect(200, 50, 120, 120, '#fff')
        map_3 = game.add.bitmapData(800, 800)
        map_3.rect(380, 50, 120, 120, '#fff')
        map.addToWorld()
        map_2.addToWorld()
        map_3.addToWorld()
